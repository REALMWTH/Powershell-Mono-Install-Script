...
$vcredist2005_x64 = "$($env:TEMP)\vcredist2005_x64.exe"
$vcredist2005_x86 = "$($env:TEMP)\vcredist2005_x86.msi"
...
$vcredist2008_x64 = "$($env:TEMP)\vcredist2008_x64.exe"
$vcredist2008_x86 = "$($env:TEMP)\vcredist2008_x86.msi"
...
$vcredist2010_x64 = "$($env:TEMP)\vcredist2010_x64.exe"
$vcredist2010_x86 = "$($env:TEMP)\vcredist2010_x86.msi"
...
$vcredist2012_x64 = "$($env:TEMP)\vcredist2012_x64.exe"
$vcredist2012_x86 = "$($env:TEMP)\vcredist2012_x86.msi"
...
$vcredist2013_x64 = "$($env:TEMP)\vcredist2013_x64.exe"
$vcredist2013_x86 = "$($env:TEMP)\vcredist2013_x86.msi"
...
$vcredist2015_2017_2019_2022_x64 = "$($env:TEMP)\vcredist2015_2017_2019_2022_x64.exe"
$vcredist2015_2017_2019_2022_x86 = "$($env:TEMP)\vcredist2015_2017_2019_2022_x86.msi"
...
$MonoPathx86 = "$($env:TEMP)\mono-6.12.0.206-gtksharp-2.12.45-win32-0.msi"
$MonoPathx64 = "$($env:TEMP)\mono-6.12.0.206-x64-0.msi"
